...
<head>
    ...
    <style type="text/css">
        ...
        #body_title{float: left; width: 37%;}
        #body_dateStart{float: left;width: 15%;}
        #body_dateEnd{}
        ...
        #body_title_1{float: left; width: 37%;}
        #body_dateStart_1{float: left;width: 15%;}
        #body_dateEnd_1{}
...
<s:iterator value='messageList'>
        <a href=""><div id="body_number"><s:property value="num"/></div></a>
        <a href=""><div id="body_title"><s:property value="title"/></div></a>
        <a href=""><div id="body_dateStart"><s:property value="Start_date"/></div></a>
        <a href=""><div id="body_edit">修改</div></a>
        <a href=""><div id="body_delete">刪除</div></a>
        <a href=""><div id="body_dateEnd"><s:property value="End_date"/></div></a>
        <hr>
</s:iterator>
